                    ...
                    <div class="row justify-content-between">
                        <div class="col-md-4 col-9 pe-0">
                            <div class="d-flex align-items-center">
                                <a href="/panel/komik/list" class="btn btn-primary border-0 rounded-1"><i class="bi bi-chevron-left"></i></a>
                ...
                <div class="card border-0 rounded-1">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="fs-sm text-gray">{{$content->is_ongoing == 1 ? 'Berlangsung' : 'Tamat'}}</p>
                            <hr>
                        </div>
                        <div class="mb-4">
                        @php
                        ...
                        @endphp 
                            <p class="text-gray mb-2 fw-500">Update Day</p>
                            <p class="fs-sm text-gray">{{$days[$content->update_day]}}{{$content->update_day_2 != NULL ? ', '. $days[$content->update_day_2] : ''}}</p>
                            <hr>
                        </div>
                    </div>
                </div>
