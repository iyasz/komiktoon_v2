                            ...
                            <div class="row mt-5">
                                <div class="col-lg-8 col-12 order-lg-0 order-1">
                                    <div class="mb-4 position-relative max-input-group">
                                        ...
                                        <input type="text" id="author-name" name="author" data-max-num="50" required value="{{$content->author}}" placeholder="Kurang dari 50 huruf" class="form-control fs-sm pe-10">
                                    ...
                                    <div class="mb-4 position-relative max-input-group">
                                        ...
                                        <input type="text" id="serial-title" value="{{$content->title}}" name="title" data-max-num="50" required placeholder="Kurang dari 50 huruf" class="form-control fs-sm pe-10">
                                            ...
                                            @foreach($genre as $data)
                                                <div class="col-auto mb-2">
                                                    <div class="form-check genre">
                                                        ...
                                                        <input class="form-check-input genre" @foreach ($categoryDetails as $item) {{$item->category_id == $data->id ? 'checked' : ''}} @endforeach type="checkbox" name="radioGenre[]" id="radio-genre{{$loop->iteration}}" value="{{$data->id}}">
                                    ...
                                    <div class="mb-4 position-relative max-input-group">
                                        ...
                                        <textarea name="synopsis" data-max-num="500" id="serial-synopsis" cols="10" rows="8" required class="form-control fs-sm pe-10" placeholder="Kurang dari 500 huruf">{{$content->synopsis}}</textarea>
                                ...
                                <div class="col-lg-4 col-12 order-lg-1 order-0">
                                    <div class="mb-3">
                                        ...
                                        <div class="square_thumbnail_show @error('thumbnail') border-primary @enderror">
                                            <img src="{{Storage::url($content->thumbnail)}}" alt="banner" data-img="{{Storage::url($content->thumbnail)}}" class="imagePreview">
                            ...
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" value="1" type="checkbox" checked name="confirm_copyright" id="yes_confirm_copyright">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" value="1" type="checkbox" checked name="confirm_contract" id="yes_confirm_contract">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary draft border-0 rounded-1 px-4 py-3 disabled">Simpan <i class="bi bi-chevron-right"></i></button>
                                </div>
                            </div>
                        </form>
...
@push('javascript')
    <script>
        ...
        $('.btn.btn-primary.draft').click(function() {
            ...
            if (genreChecked === 0) {
                $('#alertModal').modal('show');
                $('#alertModal .modal-content p').html('Genre tidak boleh kosong!');
                return false;
            }
